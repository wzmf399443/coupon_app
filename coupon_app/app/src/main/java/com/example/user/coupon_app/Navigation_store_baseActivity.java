...
public class Navigation_store_baseActivity extends AppCompatActivity {
                ...
                if (!(menuItem == NV.getMenu().getItem(CurrentMenuItem))) {//判斷使者者是否點擊當前畫面的項目，若不是，根據所按的項目做出分別的動作
                    switch (menuItem.getItemId()) {
                        case R.id.action_home:
                            ...
                            intent.setClass(Navigation_store_baseActivity.this, store_home.class);
                        ...
                        case R.id.action_issue_coupon:
                            ...
                            intent2.setClass(Navigation_store_baseActivity.this, store_home.class);
